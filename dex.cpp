...
}, 50, ThreatComparison::Lower, 1, 2, 1, {
    TargetHighestDamage(
        Remove(SHIELD)
    ),
    TargetHighestDamage(
...
DinoKind Glyptosavis("Glyptosavis", APEX, 1, {
    DinoRound(4800, 1500, 115, 25.0, 10.0, 139.99998, 0.0, 25.0, 67.0, 25.0, 100.0, 75.0, 100.0, 0.0, 100.0, 0.0, 0.0, 0.0, {
