...
g++ -std=c++17 -O3 -Wall -c -fmessage-length=0 -o arguments.o "arguments.cpp" 
...
g++ -o JWAcalc JWAcalc.o ability.o actions.o arguments.o dex.o dino.o expression.o input.o logger.o modifiers.o stats.o strprintf.o utils.o 
