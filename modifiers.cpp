...
void Affliction::Impose(Dino &target, Mod *) const
{
    target.affliction += factor;
    target.affliction_factor += factor;
}

void Affliction::Dispose(Dino &target, Mod *) const
{
	target.affliction -= factor * duration;
	target.affliction_factor -= factor;
}
